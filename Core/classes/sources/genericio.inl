...
namespace teggo
{
    ...
    _TEGGO_GENIO_FAKE_INLINE void CXX_STDCALL SprintXnumber(_XsprintAjuster<char>& _, unsigned int val, char const symbols[],
            unsigned bno)
    { SprintXnumber_(_,val,symbols,bno); }
    _TEGGO_GENIO_FAKE_INLINE void CXX_STDCALL SprintXnumber(_XsprintAjuster<wchar_t>& _, unsigned int val, char const symbols[],
            unsigned bno)
    { SprintXnumber_(_,val,symbols,bno); }
