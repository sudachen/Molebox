...
void Import1(IMAGE_IMPORT_DESCRIPTOR *import,unsigned char *base, loadlibrary_t l, getproc_t g)
  {
    ...
    for ( ; *offs ; ++func, ++offs )
      {
        ...
        if ( *offs & 0x80000000 ) // by ordinal
          ...
          n = (char*)base+(*offs+2);
        *(void**)func = g?g(m,n):GetProcAddressIndirect(m,n,0);
        if ( !*func )
          {
...
void Import(unsigned char *base, IMAGE_NT_HEADERS const *nth, loadlibrary_t l, getproc_t g)
  {
