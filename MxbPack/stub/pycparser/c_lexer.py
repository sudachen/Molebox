...
class CLexer(object):
    ...
    keywords = (
        ...
        'VOLATILE', 'WHILE', 'STDCALL', 'CDECL', 'ASM', 'QUOTE',
        'DECLSPEC'
    )
    ...
    keyword_map['__stdcall'] = 'STDCALL'
    keyword_map['__cdecl'] = 'CDECL'
    keyword_map['__asm__'] = 'ASM'
    keyword_map['__attribute__'] = 'ATTRIBUTE'
    keyword_map['__declspec'] = 'DECLSPEC'
    keyword_map['__quote'] = 'QUOTE'
