...
EXTERN_C void Import(unsigned char* base, IMAGE_NT_HEADERS const* nth, loadlibrary_t l);
EXTERN_C void Import1(IMAGE_IMPORT_DESCRIPTOR* import,unsigned char* base, loadlibrary_t l);
